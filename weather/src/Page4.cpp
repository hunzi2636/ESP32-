//
// Created by JIAO REN TIAN on 24-9-28.
//
...
#include <WiFi.h>
#include <OLED_font.h>
extern char thirdDay_textDay[32], thirdDay_tempMax[8], thirdDay_tempMin[8], thirdDay_sunrise[10], thirdDay_sunset[10],
...
void Page4::PMainShow(int xOffset)
{
    display.clearDisplay();
    display.setTextColor(WHITE);
    display.setTextSize(2);
    display.drawBitmap(112- xOffset, 0, houBitmap, 16, 16,WHITE);
    display.drawBitmap(112- xOffset, 16, tianBitmap, 16, 16,WHITE);
    String textday = String(thirdDay_textDay);
    String yuexiang=String(thirdDay_moonPhase);
    String text_night=String(thirdDay_textNight);
    ...
    display.print(":");
    display.print(thirdDay_tempMin);
    display.print("~");
    display.print(thirdDay_tempMax);
