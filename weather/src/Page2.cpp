...
extern char firstDay_humidity[4],firstDay_uvIndex[4],firstDay_textDay[32], firstDay_tempMax[8], firstDay_tempMin[8], firstDay_sunrise[10], firstDay_sunset[10],
            firstDay_moonPhase[32],firstDay_textNight[32];
;
extern Adafruit_SSD1306 display;
extern HeFeng heFeng;
